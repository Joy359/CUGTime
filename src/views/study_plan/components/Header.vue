  ...
  <div class="wrapper">
    ...
    <div class="center-section">
      <h1 class="title">
        ...
        <span class="title-text">学习计划管理</span>
        <span class="title-decoration"></span>
      </h1>
    </div>
    <!-- 查询操作 -->
    <div class="search-section">
      <el-input placeholder="请输入计划标题查询" :prefix-icon="Search" />
      <el-button :icon="Search" plain>查询</el-button>
      <el-button :icon="Refresh" type="info" plain>重置</el-button>
    </div>
    <el-button type="primary" :icon="Plus" class="new-btn" @click="handleAdd">新建计划</el-button>
  </div>
</template>
...
.wrapper {
  ...
  .title {
    ...
    &-text {
      position: relative;
      font-weight: 600;
      background: linear-gradient(135deg, #303133 60%, #409eff);
    ...
    &-decoration {
      ...
      width: 100%;
      height: 3px;
      background: linear-gradient(90deg, #409eff33, #409eff);
    }
  }
  .search-section {
    display: flex;
